...
set +e
wget https://github.com/klever1988/nanopi-openwrt/releases/download/2021-07-27/r2s.img.gz -O- | gzip -dc > $board_id.img
if [ $? -eq 0 ]; then
	wget https://github.com/klever1988/nanopi-openwrt/releases/download/2021-07-27/r2s.img.gz.md5 -O md5sum.txt
